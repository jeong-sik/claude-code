...
function opener(newMessageCount: number, existingMemories: string): string {
  ...
  return [
    ...
    '',
    `Available tools: ${FILE_READ_TOOL_NAME}, ${GREP_TOOL_NAME}, ${GLOB_TOOL_NAME}, read-only ${SHELL_COMMAND_TOOL_NAME} (ls/find/cat/stat/wc/head/tail and similar), and ${FILE_EDIT_TOOL_NAME}/${FILE_WRITE_TOOL_NAME} for paths inside the memory directory only. ${SHELL_COMMAND_TOOL_NAME} rm is not permitted. All other tools — MCP, Agent, write-capable ${SHELL_COMMAND_TOOL_NAME}, etc — will be denied.`,
    '',
